            ...
            <div  className='menu-lateral' >
                <ul  className=" lista" >
                    <li className='nav-item item'>
                        <Link to='/' className='link'><Botao background={homeIcon} >Home </Botao></Link>
                    </li>
                    <li class="nav-item  item" >
                        <Link to='/sobre' className='link'><Botao background={profileIcon}>Sobre</Botao></Link>
                    </li>
                    <li class="nav-item item" >
                        <Link to='/habilidades' className='link' > <Botao background={skillIcon}>Habilidades</Botao></Link>
                    </li>
                    <li class="nav-item item" >
                        <Link to='/portfolio' className='link' > <Botao background={portfolioIcon}>Portfolio</Botao></Link>
                    </li>
                    <li class="nav-item item" >
                        <Link to='/contatos' className='link' ><Botao background={contactIcon}>Contato</Botao></Link>
                    </li>
                </ul>
                <ul class="nav  contatos-lista "  >
                    <li class="nav-item item " >
